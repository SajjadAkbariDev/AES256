package sajjad.akbari.androidaes256;
...
// Sajjad Akbari
// sajjad.akbari.dev@outlook.com
// powerfull way to encrypt data betwen android and server side
public class AES256 {
    ...
    public AES256(final String key, final int bit) {
        this(key, bit, null);
    }

    public AES256(final String key, final int bit, final String iv) {
        if (bit == 256) {
